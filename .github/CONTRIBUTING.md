# Contributing to grantham

This outlines how to propose a change to grantham.
...
* Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("patterninstitute/grantham", fork = TRUE)`.
...
Please note that the grantham project is released with a
